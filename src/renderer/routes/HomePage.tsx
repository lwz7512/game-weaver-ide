...
const HomePage = () => (
  <div className="w-full h-screen flex ">
    <div className="left-sidepanel flex">
      <div className="sidebar w-14 bg-gray-700 text-white p-2">tools</div>
    ...
    <div className="main-part flex-1 text-black flex flex-col">
      ...
      <div className="code-editors flex-1 p-2">code editors</div>
      <div className="preview-output-panels bg-gray-200 h-60">preview</div>
    </div>
